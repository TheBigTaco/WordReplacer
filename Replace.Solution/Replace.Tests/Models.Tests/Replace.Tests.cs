...
namespace Replace.Tests
{
  ...
  {
    [TestMethod]
    public void Replacer_WillReplaceWordsInSentence_String()
    {
      ...
      Assert.AreEqual(newSentence, WordReplacer.Replacer(oldSentence, replacedWord, newWord));
    }

    [TestMethod]
    public void Replacer_WordsAreAllCaps_String()
    {
      string oldSentence = "THIS IS NEW SENTENCE";
      string replacedWord = "is";
      string newWord = "ar";
    ...
    [TestMethod]
    public void Replacer_WordsStartWithCaps_String()
    {
      string oldSentence = "This Is New Sentence";
      string replacedWord = "is";
      string newWord = "ar";
    ...
    [TestMethod]
    public void Replacer_WordsAreWeirdCase_String()
    {
    ...
    [TestMethod]
    public void Replacer_SentenceWithPunctuation_String()
    {
